...
class CentralCorridor(Scene):
    def enter(self):
        print(dedent("""
            The Gothons of Plane Percal #25 have invaded your ship and
            destroyed your entire crew. Your are the last surviving
            member and your last mission is to get the neutron destruct
            bomb from the Weapons Armory, put it in the bridge,and
            blow the ship up after getting into an escape pod.
            You're running down the central corridor to the Weapons
            Armory when a Gothon jumps out, red scaly skinj,dark grimy
...
class EscapePod(Scene):
    def enter(self):
        print(dedent("""
            ...
            like hardly any Gothons re on  the ship, so your run is 
            clear of interference. You get to the chamber with the
            escape pods, and now need to pick one to take. Some of
            them could be damaged but you don't have time to look.
            There's pods, which one do you take?
            """))
        good_pod=radint(1,5)
        guess=input("[pod#]>")
        if int(guess)!=good_pod:
            print(dedent("""
                ...
                The pod escapes out into the vold of space, then
                implodes as the hull rupture, crushing your body into
                jam jelly.
                """))
            return 'death'
        else:
